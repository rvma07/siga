...
class PresencaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Presenca'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->cod_presenca));
		}
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Presenca::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='presenca-form')
		{
