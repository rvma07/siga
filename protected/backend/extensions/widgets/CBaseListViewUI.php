 ...
 * @since 1.1
 */
abstract class CBaseListViewUI extends CWidget
{
	/**
	 ...
	 */
	public $pager=array('class'=>'CLinkPagerUI');
	/**
	...
	public function renderPager()
	{
		...
		if($this->enablePagination && $class==='CLinkPagerUI')
		{
			if(!isset($pager['cssFile']))
				CLinkPagerUI::registerCssFile();
			else if($pager['cssFile']!==false)
				CLinkPagerUI::registerCssFile($pager['cssFile']);
		}
