<div id="homeesq">
<h2 class="ui-widget-header">Informações de Cadastro</h2>
...
<div id="homedir">
  ...
  <a name="ajuda"></a>
  <h2 class="ui-widget-header">Utilize este canal para enviar alguma dúvida ou erro, referente ao Sistema Administrativo para Sete Quatro.</h2>
