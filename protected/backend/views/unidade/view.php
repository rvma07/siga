...
<?php echo CHtml::link('<span class="ui-icon ui-icon-pencil"></span>Editar', array('Unidade/update','id'=>$model->id), array('class'=>'btn ui-state-default ui-corner-all')) ?>

 <?php echo CHtml::linkButton('<span class="ui-icon ui-icon-closethick"></span>Excluir',array(
'submit'=>array('/Unidade/delete','id'=>$model->id),
