<?php
require_once(dirname(__FILE__).'/../pagers/CLinkPagerUI.php');
require_once(dirname(__FILE__).'/../CBaseListViewUI.php');

/**
 * CGridViewUI class file.
 *
...
/**
 * CGridViewUI displays a list of data items in terms of a table.
 *
 ...
 * @since 1.1
 */
class CGridViewUI extends CBaseListViewUI
{
	...
	public function init()
	{
		...
		if($this->baseScriptUrl===null)
			$this->baseScriptUrl=Yii::app()->getAssetManager()->publish(dirname(__FILE__).'/../assets/gridviewui');
	...
	protected function initColumns()
	{
		...
		foreach($this->columns as $i=>$column)
		{
			...
			//$column->headerHtmlOptions=array('class'=>'ui-state-default');
			//$column->footerHtmlOptions=array('class'=>'ui-state-default');
	...
	public function renderItems()
	{
		...
		{
			echo "<table class=\"ui-widget ui-widget-content {$this->itemsCssClass}\">\n";
	...
	public function renderTableBody()
	{
		...
		{
			echo '<tr class="ui-widget-content"><td colspan="'.count($this->columns).'">';
			$this->renderEmptyText();
			echo "</td></tr>\n";
		}
		echo "</tbody>\n";
